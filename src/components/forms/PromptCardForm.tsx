...
const promptCardSchema = z.object({
  ...
  promptText: z.string().min(1, 'Prompt text is required').max(5000, 'Prompt text must be at most 5000 characters'),
...
export function PromptCardForm({ parentPrompt, onSuccess, onCancel }: PromptCardFormProps) {
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            {form.formState.errors.promptText && (
              <p className="text-sm text-red-500">{form.formState.errors.promptText.message}</p>
            )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              {form.formState.errors.aiModelId && (
                <p className="text-sm text-red-500">{form.formState.errors.aiModelId.message}</p>
              )}
            </div>
          </div>
